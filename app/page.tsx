...
const tools = [
  ...
  },
  {
    ...
    description: 'Pick specific pages from a PDF, preview them, and download only what you need.',
    href: '/extract-pdf-pages',
    icon: (
      <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 12h5m-5 0l2-2m-2 2l2 2M20 12h-5m5 0l-2-2m2 2l-2 2" />
      </svg>
    ),
  },
  {
